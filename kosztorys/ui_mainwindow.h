...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonWstawWiersz->setGeometry(QRect(1230, 180, 93, 28));
        pushButtonUsunWiersz = new QPushButton(centralWidget);
        pushButtonUsunWiersz->setObjectName(QStringLiteral("pushButtonUsunWiersz"));
        pushButtonUsunWiersz->setGeometry(QRect(1230, 220, 93, 28));
        komunikaty = new QLabel(centralWidget);
        komunikaty->setObjectName(QStringLiteral("komunikaty"));
        komunikaty->setGeometry(QRect(30, 0, 441, 61));
        ...
        pushButtonDodajWiersz->setGeometry(QRect(1230, 140, 91, 25));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        komunikaty->setText(QApplication::translate("MainWindow", "Komunikaty", nullptr));
